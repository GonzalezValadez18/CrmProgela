...
public class Encuesta3 extends Fragment {
    ...
    private CheckBox check_lunes, check_martes, check_miercoles, check_jueves, check_viernes, check_sabado, check_domingo;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_encuesta3, container, false);
    ...
    private void guardaDatos() {
        ...
        Bundle bundle = new Bundle();
        bundle.putLong("idProspecto", idProspecto);
        Fragment fragment = new Encuesta4();
        fragment.setArguments(bundle);
        requireActivity().getSupportFragmentManager().beginTransaction()
                .replace(R.id.fragmentContainer, fragment)
                .addToBackStack(null)
